    ...
    return (
      <div className="bg-black text-white min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="text-2xl font-light mb-4 premium-text-gradient">Sorry, Only Invited Guests Can Reserve</h2>
          <p className="text-gray-300 mb-6 leading-relaxed">This is an exclusive, invitation-only event. Please check your invitation email for the correct reservation link.</p>
          <a href="/">
            <button className="premium-button bg-gradient-to-r from-amber-500 via-amber-600 to-amber-500 hover:from-amber-400 hover:via-amber-500 hover:to-amber-400 text-white px-6 py-3 rounded-full text-sm font-medium">
              Back to Home
            </button>
          </a>
        </div>
